    ...
    public class CookieAuthenticationStateProvider : AuthenticationStateProvider, IAccountManagement
    {
        ...
        public async Task<FormResult> RegisterAsync(string email, string password)
        {
            ...
            try
            {
                ...
                {
                    // Assign the role to the registered user
                    await AssignUserRoleAsync(new RoleAssign { Email=email, Role=role});
                ...
                else
                {
                    ...
                    {
                        Succeeded = false,
                        ErrorList = problemDetails == null ? defaultDetail : errors.ToArray()
                    };
                }
            }
            catch (Exception ex)
        ...
        public async Task<FormResult> AssignUserRoleAsync(RoleAssign roleAssign)
        {
            try
            {
                ...
                var response = await _httpClient.PostAsJsonAsync("RoleManager/adduserrole", roleAssign);
                ...
                else
                {
                    ...
                    var problemDetails = JsonDocument.Parse(errorContent);

                    // Parse and handle any error details if needed
                    // For simplicity, you can use the default error message
                    return new FormResult
                    {
                        Succeeded = false,
                        ErrorList = new[] { "Failed to update user role." }
                    };
                }
            }
            catch (Exception ex)
